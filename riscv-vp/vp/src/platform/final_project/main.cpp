...
public:
	...
	//Add
	addr_t sobelFilter_start_addr0 = 0x73000000;
 	addr_t sobelFilter_size0 = 0x01000000;
 	addr_t sobelFilter_end_addr0 = sobelFilter_start_addr0 + sobelFilter_size0 - 1;
	//Add
	addr_t sobelFilter_start_addr1 = 0x74000000;
 	addr_t sobelFilter_size1 = 0x01000000;
 	addr_t sobelFilter_end_addr1 = sobelFilter_start_addr1 + sobelFilter_size1 - 1;
...
int sc_main(int argc, char **argv) {
	...
	//CombinedMemoryInterface iss_mem_if("MemoryInterface1", core);
	...
	//Add
	SobelFilter sobel_filter0("sobel_filter0");
	SobelFilter sobel_filter1("sobel_filter1");
	...
	instr_memory_if *instr_mem_if0 = &core0_mem_if;
	data_memory_if *data_mem_if0 = &core0_mem_if;
	instr_memory_if *instr_mem_if1 = &core1_mem_if;
	data_memory_if *data_mem_if1 = &core1_mem_if;
	 ...
	 */
	core0.init(instr_mem_if0, data_mem_if0, &clint, entry_point, rv64_align_address(opt.mem_end_addr - 3));
	core1.init(instr_mem_if1, data_mem_if1, &clint, entry_point, rv64_align_address(opt.mem_end_addr - 589824));
	...
	// address mapping
	{
		...
		//Add
		bus.ports[it++] = new PortMapping(opt.sobelFilter_start_addr0, opt.sobelFilter_end_addr0);
		bus.ports[it++] = new PortMapping(opt.sobelFilter_start_addr1, opt.sobelFilter_end_addr1);
...

	{
		...
		//Add
		bus.isocks[it++].bind(sobel_filter0.tsock);
		bus.isocks[it++].bind(sobel_filter1.tsock);
	}
